...
$db = new DB_CONNECT();
	...
	$result = mysql_query("SELECT pid, a.uid, lat_long, lc_start, lc_finish, time_start, time_back, owner, type_car, num_seat, cost, notes, name, avata FROM TripsInfo AS a JOIN Accounts AS b ON a.uid = b.uid WHERE cost='0' OR cost='null' ORDER BY pid DESC") or die(mysql_error());
